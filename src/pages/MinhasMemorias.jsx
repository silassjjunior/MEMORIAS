...
const MinhasMemoriasPage = () => {
  ...
  const fetchMemories = async () => {
    try {
      ...
      const { data: memoriesData, error: memoriesError } = await supabase
        .from("memories")
        .select(
          `id, file_url, privacy, created_at,
  ...
  return (
    ...
    <div className="flex items-center justify-between ml-10">
        ...
        {/* Filtros + ViewMode */}
        <div className=" items-center justify-between col-span-2 flex space-x-2">
          ...
          <div className="relative">
            ...
            {filterMenuOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="absolute mt-2 flex flex-col space-y-2 bg-card dark:bg-card-dark p-2 rounded-xl shadow-lg z-30"
              >
                <button
                  onClick={() => {
                    setFilter("all")
          ...
          <div className="relative">
            ...
            {viewModeMenuOpen && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="absolute right-0 mt-2 flex flex-col space-y-2 bg-card dark:bg-card-dark p-2 rounded-xl shadow-lg z-30"
              >
                {["full", "medium", "small"].map((mode) => (
                  <button
                    ...
                    className="p-2 rounded hover:bg-gray-300 dark:hover:bg-gray-600 flex items-center justify-center"
                  >
      ...
      <main className="flex-1 p-4 transition-colors duration-300">
        {loading ? (
          <p className="text-center text-muted-foreground dark:text-muted-foreground animate-pulse">
            Carregando memórias...
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <img
                      ...
                      alt="Memória"
                      className="w-full h-96 sm:h-[28rem] object-cover rounded-2xl mb-2"
                    />
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground dark:text-muted-foreground items-center mt-2">
                      ...
                      >
                        <HeartIcon
                          size={20}
                          className={`transition ${liked ? "text-red-500 fill-red-500" : "text-gray-500"}`}
                        />
                      ...
                      <button
                        onClick={() => navigate(`/compartilharpage/${chaveId}`)}
                        className="flex items-center space-x-1 font-semibold hover:text-green-500 transition"
                      >
                        <Share size={20} />
      ...
      <AnimatePresence>
        {commentModalMemory && (
          ...
          >
            ...
            >
              <button className="absolute top-4 right-4 font-bold text-2xl text-white" onClick={closeCommentsModal}>
                &times;
              </button>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onKeyDown={(e) => e.key === "Enter" && handleAddComment(commentModalMemory.id)}
                />
                <button
